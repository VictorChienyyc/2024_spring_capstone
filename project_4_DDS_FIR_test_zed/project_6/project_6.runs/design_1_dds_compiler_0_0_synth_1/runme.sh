...
HD_PWD='C:/yc185_cardio_capstone/shorten_path/project_4_DDS_FIR_test_zed/project_6/project_6.runs/design_1_dds_compiler_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_dds_compiler_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_dds_compiler_0_0.tcl
