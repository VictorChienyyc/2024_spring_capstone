...
set_property PACKAGE_PIN V12 [get_ports {JB[4]}];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports {JB[5]}];  # "JB8"
set_property PACKAGE_PIN V9 [get_ports {JB[6]}];  # "JB9"
set_property PACKAGE_PIN V8 [get_ports {JB[7]}];  # "JB10"
