...
#
# Script generated by Vivado on Wed Apr 17 13:58:04 -0500 2024
...
#
# Usage        : fir_compiler_0.sh
#                fir_compiler_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fir_compiler_0.sh [-reset_run]
#                fir_compiler_0.sh [-reset_log]
#                fir_compiler_0.sh [-help]
#
...
#                script (type 'fir_compiler_0.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_10 -libname axi_utils_v2_0_6 -libname fir_compiler_v7_2_19 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_10 axi_utils_v2_0_6 fir_compiler_v7_2_19 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fir_compiler_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fir_compiler_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fir_compiler_0
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fir_compiler_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fir_compiler_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: fir_compiler_0.sh [-step]\n\
Usage: fir_compiler_0.sh [-lib_map_path]\n\
Usage: fir_compiler_0.sh [-reset_run]\n\
Usage: fir_compiler_0.sh [-reset_log]\n\
Usage: fir_compiler_0.sh [-keep_index]\n\
