...
design_libs=(xbip_utils_v3_0_10 axi_utils_v2_0_6 fir_compiler_v7_2_19 xil_defaultlib)
...
reset_run()
{
  files_to_remove=(ucli.key fir_compiler_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fir_compiler_0_simv.daidir vcs_lib c.obj)
